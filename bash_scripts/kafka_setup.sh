...
peg sshcmd-cluster ${CLUSTER_NAME} "curl -O https://packages.confluent.io/archive/5.5/confluent-5.5.0-2.12.tar.gz"
peg sshcmd-cluster ${CLUSTER_NAME} "tar -zxf confluent-5.5.0-2.12.tar.gz"
peg sshcmd-cluster ${CLUSTER_NAME} "mv confluent-5.5.0 confluent"
